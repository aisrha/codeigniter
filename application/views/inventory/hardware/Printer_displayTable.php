...
<div class='container'>
  <div align="center" class="buttonSwGroup">
    <button class="buttonSw"><a href="<?php echo base_url(); ?>addinventory/Printer_save">ADD PRINTER</a></button>
  </div>
  ...
  <table align="center">
    ...
    <tr>
        ...
        <td><button><a href='http://localhost/codeigniter/addinventory/Printer_update?id=<?php echo $post['id']; ?>'>Update</a></button></td>
        <td><button><a href="#" class="Printer_delete" id="<?php echo $post['id']; ?>">Delete</a></button></td>
  ...
  <script>  
      $(document).ready(function(){  
           $('.Printer_delete').click(function(){  
                var id = $(this).attr("id");  
                if(confirm("Are you sure you want to delete this?"))  
                {  
                     window.location="<?php echo base_url(); ?>addinventory/Printer_delete?id="+id;  
                }  
                else  
                {  
                     return false;  
