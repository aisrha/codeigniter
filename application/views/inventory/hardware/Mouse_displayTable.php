...
<div class='container'>
  <div align="center" class="buttonSwGroup">
    <button class="buttonSw"><a href="<?php echo base_url(); ?>addinventory/Mouse_save">ADD MOUSE</a></button>
  </div>
  ...
  <table align="center">
    ...
    <tr>
        ...
        <td><button><a href='http://localhost/codeigniter/addinventory/Mouse_update?id=<?php echo $post['id']; ?>'>Update</a></button></td>
        <td><button><a href="#" class="Mouse_delete" id="<?php echo $post['id']; ?>">Delete</a></button></td>
  ...
  <script>  
      $(document).ready(function(){  
           $('.Mouse_delete').click(function(){  
                var id = $(this).attr("id");  
                if(confirm("Are you sure you want to delete this?"))  
                {  
                     window.location="<?php echo base_url(); ?>addinventory/Mouse_delete?id="+id;  
                }  
                else  
                {  
                     return false;  
