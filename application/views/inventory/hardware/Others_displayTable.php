...
<h2>LIST OF OTHERS</h2>
<div class='container'>
  <div align="center" class="buttonSwGroup">
    <button class="buttonSw"><a href="<?php echo base_url(); ?>addinventory/Others_save">ADD OTHERS</a></button>
  </div>
  ...
  <table align="center">
    ...
    <tr>
        ...
        <td><button><a href='http://localhost/codeigniter/addinventory/Others_update?id=<?php echo $post['id']; ?>'>Update</a></button></td>
        <td><button><a href="#" class="Others_delete" id="<?php echo $post['id']; ?>">Delete</a></button></td>
  ...
  <script>  
      $(document).ready(function(){  
           $('.Others_delete').click(function(){  
                var id = $(this).attr("id");  
                if(confirm("Are you sure you want to delete this?"))  
                {  
                     window.location="<?php echo base_url(); ?>addinventory/Others_delete?id="+id;  
                }  
                else  
                {  
                     return false;  
