...
<div class='container'>
  <div align="center" class="buttonSwGroup">
    <button class="buttonSw"><a href="<?php echo base_url(); ?>addinventory/CPU_save">ADD CPU</a></button>
  </div>
  ...
  <table align="center">
    ...
    <tr>
        ...
        <td><button><a href='http://localhost/codeigniter/addinventory/CPU_update?id=<?php echo $post['id']; ?>'>Update</a></button></td>
        <td><button><a href="#" class="CPU_delete" id="<?php echo $post['id']; ?>">Delete</a></button></td>
    </tr>
    <?php $i++; ?>
    <?php endforeach; else: ?>
  ...
  <script>  
      $(document).ready(function(){  
           $('.CPU_delete').click(function(){  
                var id = $(this).attr("id");  
                if(confirm("Are you sure you want to delete this?"))  
                {  
                     window.location="<?php echo base_url(); ?>addinventory/CPU_delete?id="+id;  
                }  
                else  
                {  
                     return false;  
