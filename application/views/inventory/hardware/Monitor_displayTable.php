...
<h2>LIST OF MONITOR</h2>
<div class='container'>
  <div align="center" class="buttonSwGroup">
    <button class="buttonSw"><a href="<?php echo base_url(); ?>addinventory/Monitor_save">ADD MONITOR</a></button>
  </div>
  ...
  <table align="center">
    ...
    <tr>
        ...
        <td><button><a href='http://localhost/codeigniter/addinventory/Monitor_update?id=<?php echo $post['id']; ?>'>Update</a></button></td>
        <td><button><a href="#" class="Monitor_delete" id="<?php echo $post['id']; ?>">Delete</a></button></td>
  ...
  <script>  
      $(document).ready(function(){  
           $('.Monitor_delete').click(function(){  
                ...
                {  
                     window.location="<?php echo base_url(); ?>addinventory/Monitor_delete?id="+id;  
                }  
                else  
                {  
                     return false;  
